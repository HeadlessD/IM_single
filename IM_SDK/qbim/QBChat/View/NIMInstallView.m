...
@interface NIMInstallView ()

@end

@implementation NIMInstallView

+ (void) initialize
{
    if (self == [NIMInstallView class]) {
        NIMInstallView *circularProgressViewAppearance = [NIMInstallView appearance];
