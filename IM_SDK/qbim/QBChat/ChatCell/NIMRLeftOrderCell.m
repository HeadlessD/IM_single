...
#import "NIMRLeftOrderCell.h"
#import "NSAttributedString+Attributes.h"
@implementation NIMRLeftOrderCell
...
//        total = [SSIMSpUtil toThousand:total];
//        total = [SSIMSpUtil removePoint:total];
...
//- (UIImage *)image{
//    if (!_image) {
//        _image = [IMGGET(@"bg_dialog_-forward_left")
//                  resizableImageWithCapInsets:UIEdgeInsetsMake(30, 45, 15, 30) resizingMode:UIImageResizingModeStretch];
//    }
//    return _image;
//}
//
