...
#import "NIMSlimeView.h"
#import "SRDefine.h"
#import <QuartzCore/QuartzCore.h>

@interface NIMRefreshView()
...
- (id)initWithHeight:(CGFloat)height
{
    ...
    if (self) {
        _slime = [[NIMSlimeView alloc] initWithFrame:
        ...
        _refleshView = [[UIImageView alloc] initWithImage:IMGGET(@"sr_refresh.png")];
...
- (void)didMoveToSuperview
{
    ...
    if ([self.superview isKindOfClass:[UIScrollView class]]) {
        ...
        rect.size.width = _scrollView.frame.size.width == 0 ? self.frame.size.width : _scrollView.frame.size.width;
        self.frame = rect;
...
- (void)pullApart:(NIMRefreshView*)refreshView
{
    //拉断了
    self.broken = YES;
    _unmissSlime = YES;
