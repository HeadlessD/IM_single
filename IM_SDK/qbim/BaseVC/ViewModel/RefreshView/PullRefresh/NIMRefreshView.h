...
@class NIMRefreshView;

typedef void (^SRRefreshBlock)(NIMRefreshView* sender);

@protocol SRRefreshDelegate;

@interface NIMRefreshView : UIView{
...
@property (nonatomic, strong, readonly) NIMSlimeView *slime;
